...
function isActiveWeek(week: Week): boolean {
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2">
            <h3 className="text-sm font-mono font-semibold text-zinc-200">Week {week.label}</h3>
            {isCurrent && (
...
export function WeeklyGoals() {
  ...
  // API already returns sorted by startDate desc
